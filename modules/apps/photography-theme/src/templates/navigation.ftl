				...
				<#list nav_items as nav_item>
					...
					<li ${nav_item_attr_selected} class="${nav_item_css_class}" id="layout_${nav_item.getLayoutId()}" role="presentation">		
						...
						<#if nav_item.hasChildren()>
							<a class="dropdown-toggle" data-toggle="dropdown" aria-labelledby="layout_${nav_item.getLayoutId()}" ${nav_item_attr_has_popup} href="${nav_item.getURL()}" ${nav_item.getTarget()} role="button">
								<span>
